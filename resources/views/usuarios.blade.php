        ...
        <tr>
         ...
         @foreach($users as $usuario)
            <tr>
                  ...
                  <a data-toggle="modal" data-target="#modal_eliminar_usuario" onclick ="datos_modal_eliminar({{ $id_usuario_basicoE = $usuario->id_usuario }})">
                  ...
                  <a data-toggle="modal" data-target="#modal_cambiar_contrasenia" onclick ="datos_modal_contra({{ $id_usuario_contrasenia = $usuario->id_usuario}})">
