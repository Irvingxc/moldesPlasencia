...
<link rel="stylesheet"
    ...
    <?php if ( auth()->user()->id_planta == 2 ||  auth()->user()->id_planta == 0): ?>
<div class="row">
    ...
    <div class="col form-inline">
        ...
        <form action="{{Route('imprimirdatos_moroceli',2)}}" method="POST" class=" form-inline">
            @csrf
    ...
    <div class="col">
        ...
        <form action="{{Route('remisiones_moroceli',2)}}" method="POST">
            ...
            <button type="submit" class=" btn-info float-right" style="margin-right: 10px">
                ...
                <input name="nombre_planta" id="nombre_planta" value="Moroceli" style="display:none">
                <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                        class="bi bi-plus-square" viewBox="0 0 16 16">
                        <path
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col">
                                ...
                                <select class="vitolas_search" style="width:150px" type="text" list="prediccionvitola" id="txt_vitola"
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col">
                                ...
                                <input class="form-control" id="txt_reparacion" name="reparacion" placeholder="Cantidad"
                                    type="number"autocomplete="off">
                                <input name="id_plantamo" value='2' hidden />
