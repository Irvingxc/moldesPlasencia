                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col">
                                ...
                                <select class="vitolas_search" type="text" style = "width:90%;" list="prediccionvitola" id="txt_vitola"
...
<script type="text/javascript">
    function validar() {
       ...
       // alert(v_irregulares);
        ...
        //var v_material = JSON.parse(descodificar);
      // var v_material = document.getElementById('txt_figuraytipo').value;
