...
<div class="row">
    ...
    <div class="col form-inline">
        ...
        <form action="{{Route('imprimirdatos_gualiqueme',4)}}" method="POST" class=" form-inline">
            ...
            <input name="materialimprimir" id="materialimprimir"  hidden value={{$materialB}} >
    ...
    <div class="col">
        ...
        <form action="{{Route('remisiones_gualiqueme',4)}}" method="POST">
...
<form action="{{Route('insertar_moldes_gualiqueme',4)}}" method="POST" id="FormMoldes" name="FormMoldes">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col">
                                ...
                                <input class="form-control" id="txt_reparacion" name="reparacion" placeholder="Cantidad"
                                    type="number"autocomplete="off">
                                <input name="id_plantamo" value='4' hidden />
...
<!-- INICIO MODAL VITOLA -->
<form action="{{Route('insertar_vitola_gualiqueme',4)}}" method="POST" name="formvitola">
...
<form action="{{Route('insertar_figura_gualiqueme',4)}}" method="POST">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    @csrf
                    <input name="id_plantamo" value='4
        ' hidden />
                </div>
            </div>
        </div>
...
<form action="{{Route('actualizar_moldes_gualiqueme',4)}}" method="POST" name="formulario_actualizar">
...
<script type="text/javascript">
    function validar() {
        ...
        var concat_fivi = v_figura + "  " + v_vitola + "  " + v_material;
