    ...
    <body>
        ...
        <script type="text/javascript">
            function enviadas() {
                ...
                document.formulario_enviadas.action = '/buscar_remision_sanMarcos/3'
                document.formulario_imprimir.action = '/buscar_remision_imprimir_enviadassanmarcos'
            ...
            function recibidas() {
                ...
                document.formulario_enviadas.action = '/buscar_remision_re_sanMarcos/3'
                document.formulario_imprimir.action = '/buscar_remision_imprimir_recibidassanmarcos'
        ...
        <div class="col form-inline">
            ...
            <form action="{{Route('buscar_remision_sanMarcos',3)}}" method="POST" class="form-inline"
                name="formulario_enviadas" id="formulario_enviadas">
                @csrf
                <input type="text" name="id_planta_remision" value="3" hidden>
            ...
            <form action="" method="POST" name="formulario_imprimir" id="formulario_imprimir " class=" form-inline">
                ...
                <input type="text" name="id_planta_re" id="id_planta_re" value="3" hidden>

                <input type="text" name="nombre_fa" id="nombre_fa" value="San Marcos" hidden>
            ...
            <script type="text/javascript">
                function datos_remisiones(id) {
                    ...
                    if (document.getElementById('nombre_recibido').value === "Paraíso Cigar") {
                        ...
                        document.formulario_mostrar.id_otra.value = "1";
                    } else if (document.getElementById('nombre_recibido').value === "Morocelí") {

                        document.formulario_mostrar.id_otra.value = "2";
                    } else
                    if (document.getElementById('nombre_recibido').value === "Gualiqueme") {


                        document.formulario_mostrar.id_otra.value = "4";
                    }
            ...
            <form action="{{Route('insertar_solicitud_sanmarcos')}}" method="POST">
                @csrf
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-5 col">
                                            ...
                                            <input name="id_planta_notificaciones" id="id_planta_notificaciones"
                                            ...
                                            <input name="nombreplanta_notificacion" id="nombreplanta_notificacion"
                                                value="San Marcos" style="display:none">

                                            <label for="txt_sucursales" class="form-label"
                                                style="width:180px; text-align:center; font-size:20px;">Para</label>
                                            <select class="form-control" id="planta_notificacion"
                                                name="planta_notificacion" onchange="showDiv('hidden_div', this)"
                                                ...
                                                <option value="1" style=" text-align:center; font-size:16px;">Paraíso
                                                    Cigar</option>
                                                <option value="2" style=" text-align:center; font-size:16px;">Morocelí
                                                </option>
                                                <option value="4" style=" text-align:center; font-size:16px;">
                                                    Gualiqueme</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-5 col">
                                            <label for="txt_estado" class="form-label"
                                                ...
                                                tipo</label>
                                            <input class="form-control" id="figura_notificacion"
                                                name="figura_notificacion" autocomplete="off"
                                                placeholder="Ingrese la Figura y tipo" required
                                                style="width:180px; text-align:center; height: 50px; text-align:center; font-size:18px;">
                                            </input>
                                        </div>
                                        ...
                                        <div class="mb-5 col">
                                            ...
                                            <input class="form-control" id="vitola_notificacion"
                                                name="vitola_notificacion" autocomplete="off"
                                                placeholder="Ingrese la Vitola" required
                                                style="width:180px; text-align:center; height: 50px; text-align:center; font-size:18px;">
                                        ...
                                        <div class="mb-5 col">
                                            ...
                                            <input class="form-control" type="number" id="cantidad_notificacion"
                                                style="width:180px; text-align:center; height: 50px; text-align:center; font-size:18px;"
                                                name="cantidad_notificacion" placeholder="Ingresa la cantidad"
            ...
            <form id="formulario_mostrar" name="formulario_mostrar" action="{{Route('actualizarremision_sanMarcos',3)}}"
                method="POST">

                @csrf
                <?php use App\Http\Controllers\sucursal_sanMarcos; ?>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <input name="id_planta" id="id_planta" value="3" hidden />
            ...
            <form action="{{Route('insertarremisiones_sanMarcos',3)}}" method="POST" id="FormRemisiones"
                name="FormRemisiones">
                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-5 col">
                                            ...
                                            <select class="form-control" id="txt_sucursales" name="txt_sucursales"
                                                ...
                                                <option value="Paraíso Cigar"
                                                    style=" text-align:center; font-size:16px;">Paraíso Cigar</option>
                                                <option value="Morocelí" style=" text-align:center; font-size:16px;">
                                                    Morocelí</option>
                                                <option value="Gualiqueme" style=" text-align:center; font-size:16px;">
                                                    Gualiqueme</option>
                                                <option value="5" style=" text-align:center; font-size:16px;">Otra
                                                    Fabrica</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-5 col" style="display:none;" id="hidden_div">
                                            <label for="txt_otra_fabrica" class="form-label"
                                                style="width:180px; text-align:center; font-size:20px;">Otra
                                                empresa</label>
            ...
            <script>
                function agregarremision() {
                    ...
                    if (document.getElementById('txt_sucursales').value === "Gualiqueme") {

                        document.FormRemisiones.id_otra_plan.value = "4";
                    }else
                    ...
                    for (var i = 0; i < bodega.length; i++) {
                        ...
                        if (bodega[i].fivi === document.getElementById('id_tipo').value) {
                            ...
                            cantidad_disponible = bodega[i].moldesDisponibles;
                    ...
                    if (cantidad_input > cantidad_disponible && select_estado === "Buenos") {
                        toastr.error(
                            'Esta cantidad supera a la de su inventario de moldes, verifique la cantidad de moldes disponibles',
                            'ERROR', {
                                "progressBar": true,
                                "closeButton": false,
                                "preventDuplicates": true,
